...
#     print(f"Partidas jogadas: {p1.get_partidas_jogadas()}")
#     print(f"Partidas vencidas: {p1.get_partidas_vencidas()}")
#     print(f"Gols marcados: {p1.get_gols_marcados()}")
#     print(f"Assistências feitas: {p1.get_assistencias_feitas()}")

# for p2 in time2.lista_jogadores:
#     print(f"Nome: {p2.get_nome()}")
#     print(f"Partidas jogadas: {p2.get_partidas_jogadas()}")
#     print(f"Partidas vencidas: {p2.get_partidas_vencidas()}")
#     print(f"Gols marcados: {p2.get_gols_marcados()}")
#     print(f"Assistências feitas: {p2.get_assistencias_feitas()}")
