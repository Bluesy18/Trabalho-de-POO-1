...
j3 = Defensor("Diogo", "5", "ZAGE", 8, 7, 10, 7, 4, 2, 8)
j4 = Defensor("Thiago", "42", "ZAGD", 1, 10, 3, 6, 2, 2, 6)
j5 = Defensor("Davi", "12", "LD", 8, 9, 6, 7, 6, 8, 4)
j6 = MeioCampista("Denian", "8", "VOL", 4, 7, 8, 4, 6, 7, 5)
j7 = MeioCampista("Vini", "7" , "MCE", 6, 5, 9, 5, 7, 6, 8)
j8 = MeioCampista("André", "11", "MCD", 1, 3, 6, 7, 6, 6, 6)
